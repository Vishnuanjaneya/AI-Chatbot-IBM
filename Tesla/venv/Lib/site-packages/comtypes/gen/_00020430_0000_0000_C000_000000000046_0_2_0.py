...
__all__ = [
    'OLE_CANCELBOOL', 'Font', 'Picture', 'Checked',
    'OLE_YPOS_HIMETRIC', 'OLE_XSIZE_PIXELS', 'OLE_XPOS_PIXELS',
    'Monochrome', 'FONTUNDERSCORE', 'OLE_OPTEXCLUSIVE', 'FONTNAME',
    'Gray', 'IPictureDisp', 'LoadPictureConstants', 'Unchecked',
    'IFontEventsDisp', 'OLE_XPOS_CONTAINER', 'IFontDisp', 'FONTBOLD',
    'FontEvents', 'FONTSTRIKETHROUGH', 'OLE_COLOR',
    'OLE_YSIZE_CONTAINER', 'IFont', 'FONTITALIC', 'FONTSIZE',
    'OLE_XSIZE_CONTAINER', 'OLE_YSIZE_HIMETRIC', 'Default',
    'VgaColor', 'OLE_XSIZE_HIMETRIC', 'IPicture', 'OLE_YPOS_PIXELS',
    'OLE_YPOS_CONTAINER', 'StdPicture', 'OLE_XPOS_HIMETRIC',
    'StdFont', 'OLE_YSIZE_PIXELS', 'OLE_TRISTATE', 'Color',
    'OLE_ENABLEDEFAULTBOOL', 'OLE_HANDLE'
]

_check_version('1.1.14', 1575709685.550032)
