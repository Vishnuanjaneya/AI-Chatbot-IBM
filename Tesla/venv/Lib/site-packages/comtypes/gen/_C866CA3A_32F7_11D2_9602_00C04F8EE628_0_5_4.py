...
__all__ = [
    'DISPID_SOTCategory', 'SPWT_PRONUNCIATION', 'SSSPTRelativeToEnd',
    'DISPID_SRRPhraseInfo', 'SVEPrivate', 'SPSNotOverriden',
    'SpeechMicTraining', 'ISpeechPhraseReplacements',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRGDictationUnload',
    'DISPID_SGRsCount', 'SpeechPropertyLowConfidenceThreshold',
    'eLEXTYPE_PRIVATE17', 'SSTTDictation', 'SAFT8kHz16BitMono',
    'DISPID_SGRSTPropertyId', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechCategoryAppLexicons', 'SVEWordBoundary', 'SVP_6',
    'SDA_One_Trailing_Space', 'ISpeechPhraseAlternate',
    'SPPS_Function', 'DISPID_SVEVoiceChange', 'SPEI_SOUND_START',
    'SPEI_RESERVED1', 'DISPID_SVEPhoneme', 'SPWORDTYPE',
    'DISPID_SABufferInfo', 'SPEI_PHONEME', 'SPEI_RESERVED5',
    'DISPID_SRCSetAdaptationData', 'DISPIDSPRG',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SpeechLexicon',
    'DISPIDSPTSI_SelectionLength', 'ISpRecoGrammar2', 'SRTStandard',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpRecoContext', 'SAFTDefault',
    'DISPID_SOTCGetDataKey', 'SREInterference', 'SPCS_ENABLED',
    'DISPID_SVSkip', 'SpPhoneticAlphabetConverter',
    'DISPID_SPRuleParent', 'DISPID_SGRsFindRule', 'DISPID_SGRsAdd',
    'SVPAlert', 'DISPID_SRCBookmark', 'SpPhoneConverter',
    'ISpResourceManager', 'DISPID_SpeechVoiceStatus', 'SGSEnabled',
    'SP_VISEME_4', 'DISPID_SPERequiredConfidence',
    'Speech_StreamPos_RealTime', 'DISPID_SpeechVoice',
    'SAFT48kHz16BitMono', 'SpVoice', 'DISPID_SRGCmdSetRuleState',
    'SITooFast', 'DISPID_SRSCurrentStreamNumber',
    'SDA_Consume_Leading_Spaces', 'SPDKL_DefaultLocation',
    'ISpeechRecoResult2', 'SAFT11kHz8BitMono',
    'DISPID_SVSInputSentenceLength', 'DISPID_SDKDeleteKey',
    '_RemotableHandle', 'DISPID_SVEBookmark', 'SPPS_NotOverriden',
    'DISPID_SPIGrammarId', 'SAFTCCITT_ALaw_11kHzStereo', 'SLTUser',
    'SGRSTTEpsilon', 'SP_VISEME_12', 'SVP_8', 'SPSERIALIZEDRESULT',
    'Speech_StreamPos_Asap', 'DISPID_SAVolume', 'SpeechVoiceEvents',
    'SpeechUserTraining', 'DISPID_SpeechGrammarRule',
    'DISPID_SpeechPhraseElements', 'SRSInactiveWithPurge',
    'DISPID_SpeechGrammarRules', 'eLEXTYPE_PRIVATE10',
    'SPEI_START_SR_STREAM', 'SVP_21', 'DISPID_SpeechPhraseProperties',
    'SpeechCategoryVoices', 'SPBO_NONE', 'DISPID_SpeechAudioStatus',
    'DISPID_SAFGetWaveFormatEx', 'SVP_18',
    'DISPID_SpeechObjectTokens', 'SPAS_RUN', 'SVF_Emphasis',
    'SPEI_HYPOTHESIS', 'DISPID_SOTRemoveStorageFileName',
    'SPWT_DISPLAY', 'DISPID_SPIElements', 'SRSInactive',
    'SRCS_Enabled', 'SPSHT_NotOverriden', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SDKCreateKey',
    'ISpeechLexiconWords', 'DISPID_SGRAddState', 'SPBO_TIME_UNITS',
    'SPCT_SLEEP', 'DISPID_SRProfile', 'DISPID_SWFEBlockAlign',
    'SAFT44kHz16BitStereo', 'SPRS_INACTIVE',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPEsCount',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSTNextState',
    'DISPID_SPEAudioSizeBytes', 'IInternetSecurityMgrSite',
    'SGRSTTWildcard', 'DISPID_SRRTTickCount', 'SPEVENT',
    'SP_VISEME_10', 'DISPID_SPERetainedSizeBytes',
    'ISpeechRecoContext', 'DISPID_SPEPronunciation',
    'eLEXTYPE_MORPHOLOGY', 'SAFT22kHz8BitStereo', 'SP_VISEME_18',
    'SpeechRegistryLocalMachineRoot', 'SPBOOKMARKOPTIONS',
    'SPPS_RESERVED3', 'SDTRule', 'DISPID_SADefaultFormat',
    'DISPID_SVAlertBoundary', 'SPEVENTSOURCEINFO',
    'SpeechTokenValueCLSID', 'SVSFVoiceMask',
    'DISPID_SOTCreateInstance', 'DISPID_SRRSaveToMemory',
    'SSFMOpenForRead', 'SVEBookmark', 'SDKLDefaultLocation',
    'SREAllEvents', 'DISPID_SAFGuid',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPSERIALIZEDPHRASE',
    'SRERecoOtherContext', 'SPEI_ADAPTATION',
    'DISPID_SpeechLexiconProns', 'DISPID_SpeechRecoResultTimes',
    'SPPHRASEREPLACEMENT', 'SECNormalConfidence', 'SVP_3',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRGId', 'SP_VISEME_8',
    'SPADAPTATIONRELEVANCE', 'DISPID_SWFEBitsPerSample',
    'DISPID_SLWLangId', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SLPSymbolic', 'SpeechGrammarTagWildcard',
    'SPCT_SUB_DICTATION', 'SVESentenceBoundary',
    'SpNullPhoneConverter', 'DISPID_SRCERequestUI', 'SPSNoun',
    'SPSInterjection', 'DISPID_SPRuleName', 'DISPID_SBSWrite',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SGRSTPropertyValue',
    'SAFT32kHz8BitStereo', 'DISPID_SPEsItem', 'SPPHRASEELEMENT',
    'SVP_17', 'DISPID_SRRGetXMLResult', 'DISPID_SVGetAudioOutputs',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRSClsidEngine',
    'DISPID_SVEAudioLevel', 'SpeechEmulationCompareFlags',
    'DISPID_SRCEEndStream', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SABIEventBias',
    'eLEXTYPE_RESERVED4', 'SPBINARYGRAMMAR', 'SP_VISEME_19',
    'DISPID_SDKGetBinaryValue', 'DISPID_SpeechPhraseReplacements',
    'SPVOICESTATUS', 'DISPID_SOTCDefault',
    'DISPID_SpeechCustomStream', 'DISPID_SRCCreateGrammar',
    'DISPID_SREmulateRecognition', 'DISPID_SPRuleId',
    'SpeechCategoryPhoneConverters', 'SPWAVEFORMATTYPE',
    'ISpeechResourceLoader', 'SREFalseRecognition', 'SREAdaptation',
    'DISPID_SOTId', 'SPPHRASERULE', 'DISPID_SGRClear',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SAEventHandle',
    'ISpeechGrammarRule', 'SpAudioFormat', 'WAVEFORMATEX',
    'ISpeechMMSysAudio', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechRecognizer', 'ISpeechPhraseProperty', 'SPVPRI_ALERT',
    'SVEViseme', 'SPVISEMES', 'ISpObjectTokenCategory',
    'SpeechAudioFormatType', 'SREStreamStart', 'SLTApp',
    'SAFTADPCM_11kHzStereo', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT48kHz16BitStereo', 'DISPID_SRGetFormat',
    'SDA_No_Trailing_Space', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SGRName', 'eLEXTYPE_PRIVATE9', 'DISPID_SRRSpeakAudio',
    'SPEI_RESERVED6', 'ISpeechPhraseElements', 'SDTAlternates',
    'STSF_FlagCreate', 'ISpeechTextSelectionInformation',
    'SpUnCompressedLexicon', 'SVP_20', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRRecognizer',
    'SpeechVoiceCategoryTTSRate', 'SPWORDLIST', 'DISPID_SPRulesItem',
    'eLEXTYPE_PRIVATE7', 'SPRECOSTATE', 'SPRECORESULTTIMES',
    'DISPID_SDKSetBinaryValue', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'eLEXTYPE_PRIVATE4', 'SpeechInterference', 'DISPID_SRState',
    'SVP_11', 'SASClosed', 'STSF_AppData', 'SAFTADPCM_22kHzStereo',
    'SPEI_SR_RETAINEDAUDIO', 'UINT_PTR', 'SPSEMANTICFORMAT',
    'SRARoot', 'SBOPause', 'DISPID_SpeechFileStream',
    'DISPID_SpeechPhraseProperty', 'SPEI_SR_PRIVATE',
    'DISPID_SRGIsPronounceable', 'SpeechPartOfSpeech',
    'DISPID_SRSAudioStatus', 'SVSFParseSsml',
    'DISPID_SASCurrentSeekPosition', 'SPEI_MIN_SR',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRAttributes',
    'DISPID_SMSSetData', 'SVP_7', 'SpeechRunState', 'SREHypothesis',
    'DISPID_SVGetAudioInputs', 'SAFT16kHz16BitStereo', 'SGSExclusive',
    'SPPS_RESERVED1', 'DISPID_SPEAudioTimeOffset', 'SPAUDIOSTATUS',
    'DISPID_SGRSTWeight', 'SPEI_INTERFERENCE',
    'SpeechVoiceSpeakFlags', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SVRate', 'SpeechGrammarTagDictation', 'ISpeechBaseStream',
    'SpeechTokenContext', 'SGDisplay', 'SPSModifier', 'SASRun',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SGRSTsCount',
    'DISPID_SPRFirstElement', 'ISpeechMemoryStream',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SPILanguageId', 'SPAO_RETAIN_AUDIO', 'SPAS_CLOSED',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPRECOCONTEXTSTATUS',
    'SpCompressedLexicon', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPIEnginePrivateData', 'eLEXTYPE_PRIVATE16', 'SDTAudio',
    'SPDATAKEYLOCATION', 'DISPID_SRGCmdLoadFromMemory',
    'SVEVoiceChange', 'SVSFNLPSpeakPunc', 'SPRST_INACTIVE',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRCState',
    'DISPID_SRCESoundEnd', 'DISPID_SLPsCount', 'SPWF_INPUT',
    'DISPID_SPRuleChildren', 'SpeechAudioProperties',
    'DISPID_SPACommit', 'SP_VISEME_16', 'SpeechRecognizerState',
    'DISPID_SMSALineId', 'DISPID_SVSLastBookmarkId',
    'SAFTADPCM_8kHzMono', 'SPSFunction', 'SPSMF_SAPI_PROPERTIES',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRSNumberOfActiveRules',
    'SPEI_SOUND_END', 'SSTTTextBuffer', 'SPLO_DYNAMIC', 'STCAll',
    'SPGS_EXCLUSIVE', 'SpPhraseInfoBuilder', 'SAFT24kHz8BitMono',
    'DISPID_SRCEBookmark', 'SVF_Stressed', 'SSTTWildcard',
    'DISPID_SRCEStartStream', 'DISPID_SRCEInterference',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SpeechPhraseAlternates',
    'SVP_10', 'ISpVoice', 'SP_VISEME_0', 'SRTAutopause',
    'SAFT16kHz8BitStereo', 'SPWORDPRONOUNCEABLE',
    'DISPID_SpeechLexiconWords', 'eLEXTYPE_RESERVED10',
    'SPAUDIOSTATE', 'DISPID_SDKGetStringValue', 'DISPID_SVSPhonemeId',
    'SpeechCategoryRecognizers', 'DISPID_SOTGetAttribute', 'IStream',
    'DISPID_SpeechDataKey', 'DISPID_SBSFormat', 'SPRULE',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechLexiconWord',
    'DISPID_SGRSAddRuleTransition', 'SVP_9',
    'DISPID_SPRuleFirstElement', 'SVP_19', 'SPAS_PAUSE',
    'DISPID_SLRemovePronunciation', 'SVEEndInputStream',
    'DISPID_SPAStartElementInResult', 'SPPS_Verb',
    'ISequentialStream', 'SDTLexicalForm', 'DISPID_SpeechPhraseRule',
    'SPSHORTCUTTYPE', 'ISpRecoCategory', 'SGPronounciation',
    'SPSHORTCUTPAIRLIST', 'SASStop', 'ISpNotifyTranslator',
    'DISPID_SLWType', 'SPINTERFERENCE_TOOQUIET', 'ISpeechPhraseRules',
    'DISPID_SpeechVoiceEvent', 'SP_VISEME_15', 'SPEI_RECOGNITION',
    'eLEXTYPE_LETTERTOSOUND', 'SSFMCreate', '_ISpeechVoiceEvents',
    'DISPID_SVPause', 'SECFIgnoreKanaType',
    'SpeechPropertyAdaptationOn', 'DISPID_SPRNumberOfElements',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPRST_ACTIVE',
    'DISPID_SGRAddResource', 'SAFT12kHz8BitStereo', 'STCRemoteServer',
    'DISPID_SpeechRecoResult', 'ISpeechPhraseInfoBuilder',
    'eLEXTYPE_RESERVED8', 'SPSTREAMFORMATTYPE',
    'DISPID_SRRTStreamTime', 'DISPID_SBSSeek',
    'DISPID_SRCEHypothesis', 'DISPID_SRStatus', 'DISPID_SPPs_NewEnum',
    'SVEStartInputStream', 'SPAR_Unknown', 'SPGS_ENABLED',
    'SWPUnknownWordPronounceable', 'SRAInterpreter',
    'SGLexicalNoSpecialChars', 'SpeechDiscardType', 'DISPID_SRCVoice',
    'DISPID_SLPPartOfSpeech', 'SpeechVoicePriority',
    'SpeechAudioFormatGUIDText', 'DISPID_SRCPause', 'SDTProperty',
    'DISPID_SRGCmdLoadFromFile', 'SAFT11kHz16BitStereo',
    'DISPID_SPPValue', 'SpSharedRecoContext', 'SVSFIsXML',
    'SPEI_TTS_PRIVATE', 'DISPID_SGRsCommitAndSave',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPCT_SUB_COMMAND',
    'SpeechPropertyResponseSpeed',
    'SpeechPropertyHighConfidenceThreshold', 'ISpRecoContext2',
    'ISpeechAudioFormat', 'DISPID_SLGetPronunciations',
    'SSFMOpenReadWrite', 'SpWaveFormatEx', 'IEnumSpObjectTokens',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRCRecognizer',
    'DISPID_SpeechPhraseElement', 'SBONone',
    'DISPID_SRRTOffsetFromStart', 'SECFIgnoreCase',
    'SPINTERFERENCE_NONE', 'SPWF_SRENGINE', 'SpeechAudioState',
    'DISPID_SVSLastBookmark', 'SVSFPersistXML', 'DISPID_SRDisplayUI',
    'ISpXMLRecoResult', 'DISPID_SPIEngineId', 'DISPID_SLPsItem',
    'DISPID_SPIAudioSizeTime', 'SpeechAllElements', 'SRCS_Disabled',
    'SFTInput', 'ISpStream', 'ISpeechRecoResult',
    'SpeechPropertyResourceUsage', 'DISPID_SRCEAdaptation',
    'SAFT8kHz8BitStereo', 'SREPropertyNumChange', 'SRERequestUI',
    'tagSPPROPERTYINFO', 'DISPID_SPEs_NewEnum',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechDictationTopicSpelling',
    'DISPID_SVGetProfiles', 'SPINTERFERENCE_LATENCY_WARNING',
    'SWTAdded', 'DISPID_SVVolume', 'SAFT32kHz16BitStereo', 'SVP_2',
    'ISpPhoneticAlphabetSelection', 'SPINTERFERENCE_NOISE',
    'ISpeechLexicon', 'eLEXTYPE_USER', 'SP_VISEME_20',
    'SpeechBookmarkOptions', 'SINone', 'DISPID_SRCERecognition',
    'SGDSActiveWithAutoPause', 'SAFT16kHz16BitMono',
    'DISPID_SOTMatchesAttributes',
    'SpeechPropertyNormalConfidenceThreshold', 'SDKLCurrentConfig',
    'DISPID_SVSLastResult', 'SITooLoud', 'SPFM_CREATE_ALWAYS',
    'SECFDefault', 'DISPID_SRCRetainedAudioFormat', 'SVSFIsFilename',
    'ISpeechRecoResultTimes', 'DISPID_SGRsDynamic', 'SRESoundStart',
    'tagSTATSTG', 'DISPID_SABufferNotifySize', 'DISPID_SLWWord',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVSFDefault',
    'DISPID_SPELexicalForm', 'SpInProcRecoContext', 'SpObjectToken',
    'DISPID_SDKGetlongValue', 'SAFT22kHz8BitMono', 'DISPID_SAStatus',
    'DISPID_SpeechMMSysAudio', 'ISpObjectWithToken',
    'SPFM_OPEN_READONLY', 'DISPID_SPIGetText',
    'SpeechWordPronounceable', 'STSF_LocalAppData', 'SPPARTOFSPEECH',
    'Speech_Default_Weight', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SASState', 'IEnumString', 'ISpStreamFormatConverter',
    'SLODynamic', 'DISPID_SBSRead', 'DISPID_SVIsUISupported',
    'SPPHRASE', 'DISPID_SDKEnumValues', 'DISPID_SDKSetLongValue',
    'DISPID_SLWsCount', 'DISPID_SOTSetId', 'ISpeechPhraseProperties',
    'SAFTADPCM_44kHzMono', 'DISPID_SOTRemove',
    'DISPID_SGRSAddWordTransition', 'SRAORetainAudio', 'SPBO_PAUSE',
    'SPSHT_EMAIL', 'SpeechVoiceSkipTypeSentence', 'SPSHT_OTHER',
    'ISpeechRecoGrammar', 'ISpShortcut', 'SRTSMLTimeout',
    'SpeechDataKeyLocation', 'ISpeechFileStream',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFT22kHz16BitStereo',
    'SPWORDPRONUNCIATIONLIST', 'SpeechStreamFileMode', 'SVP_4',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechLexiconType', 'SVSFIsNotXML',
    'DISPID_SGRInitialState', 'eLEXTYPE_RESERVED7',
    'DISPID_SVGetVoices', 'SVEAudioLevel', 'SASPause',
    'SPLOADOPTIONS', 'SLOStatic', 'SPCS_DISABLED',
    'SpeechSpecialTransitionType', 'SPLO_STATIC',
    'SAFTGSM610_11kHzMono', 'DISPID_SPRDisplayAttributes',
    'SGLexical', 'DISPID_SASetState', 'DISPID_SPRulesCount',
    'SpeechCategoryAudioIn', 'DISPID_SVEViseme',
    'DISPID_SRCEAudioLevel', 'ISpeechGrammarRules',
    'DISPID_SLGetWords', 'SPEI_RECO_OTHER_CONTEXT', 'ISpeechAudio',
    'DISPID_SGRsCommit', 'ISpeechGrammarRuleState',
    'DISPID_SVSpeakStream', 'SP_VISEME_13', 'ISpEventSource',
    'SPEI_VISEME', 'SPWORDPRONUNCIATION', 'eLEXTYPE_PRIVATE3',
    'SPGS_DISABLED', 'SVP_5', 'SpeechGrammarWordType',
    'DISPID_SPPsItem', 'SpeechTokenKeyFiles',
    'DISPIDSPTSI_ActiveOffset', 'SpObjectTokenCategory',
    'eLEXTYPE_PRIVATE12', 'SpeechRuleAttributes',
    'SPRECOGNIZERSTATUS', 'SREStateChange', 'SVSFPurgeBeforeSpeak',
    'eLEXTYPE_PRIVATE15', 'SGRSTTDictation', 'SGDSActive',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRRAudioFormat',
    'eLEXTYPE_PRIVATE5', 'SPRS_ACTIVE', 'SpeechRecoEvents',
    'ISpMMSysAudio', 'DISPID_SASFreeBufferSpace', 'SREStreamEnd',
    'SVPNormal', 'DISPID_SOTGetDescription', 'eLEXTYPE_PRIVATE20',
    'SPVPRI_OVER', 'DISPID_SRCEPhraseStart', 'DISPID_SGRSTransitions',
    'SSFMCreateForWrite', 'SPPS_SuppressWord',
    'SpeechEngineConfidence', '_ISpeechRecoContextEvents', 'SVP_16',
    'DISPID_SASNonBlockingIO', 'SP_VISEME_17',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPIRule',
    'SpSharedRecognizer', 'SINoSignal',
    'DISPID_SRCAudioInInterferenceStatus', 'SVEAllEvents',
    'SpResourceManager', 'DISPID_SPISaveToMemory',
    'DISPID_SVSInputSentencePosition', 'SAFTNonStandardFormat',
    'DISPID_SRCEventInterests', 'SAFTExtendedAudioFormat',
    'SpeechTokenIdUserLexicon', 'SPRULESTATE', 'DISPID_SOTs_NewEnum',
    'DISPID_SLGetGenerationChange',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SOTsItem',
    'DISPID_SPAs_NewEnum', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPPId', 'SECFIgnoreWidth', '_SPAUDIOSTATE', 'SRAImport',
    'SpeechTokenKeyAttributes', 'SRSEIsSpeaking',
    'DISPID_SABIMinNotification', 'ISpeechPhraseInfo',
    'ISpeechPhraseRule', 'SPSEMANTICERRORINFO',
    'DISPID_SpeechRecognizer', 'DISPID_SGRsItem', 'DISPID_SFSClose',
    'SGRSTTTextBuffer', 'SAFTGSM610_22kHzMono',
    'DISPID_SOTIsUISupported', 'SP_VISEME_21', 'SpeechLoadOption',
    'SPPS_Modifier', 'DISPID_SRSetPropertyString', 'SAFT8kHz8BitMono',
    'SP_VISEME_9', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SREBookmark', 'DISPID_SPEDisplayAttributes', 'DISPID_SOTDataKey',
    'DISPID_SRGSetWordSequenceData', 'eLEXTYPE_PRIVATE6',
    'SGDSInactive', 'ISpeechPhoneConverter', 'SRATopLevel',
    'SPCONTEXTSTATE', 'DISPID_SPRuleEngineConfidence',
    'SPLEXICONTYPE', 'SPPHRASEPROPERTY', 'DISPID_SRCRetainedAudio',
    'SAFT48kHz8BitMono', 'SVPOver',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPCT_COMMAND',
    'DISPID_SFSOpen', 'STCLocalServer', 'DISPID_SGRs_NewEnum',
    'ISpeechLexiconPronunciation', 'DISPID_SVSRunningState',
    'ISpStreamFormat', 'DISPID_SMSADeviceId', 'SAFT44kHz16BitMono',
    'DISPID_SLPType', 'SPEVENTENUM', 'DISPID_SVResume',
    'DISPID_SpeechRecoContext', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SRGReset', 'SP_VISEME_2', 'SRTReSent', 'SPEI_MIN_TTS',
    'SAFT12kHz16BitStereo', 'DISPIDSPTSI', 'SPRST_ACTIVE_ALWAYS',
    'SGSDisabled', 'SPGRAMMARWORDTYPE', 'DISPID_SRRTimes',
    'DISPID_SVEventInterests', 'SPPS_LMA', 'DISPID_SRGCommit',
    'DISPID_SPPConfidence', 'DISPID_SPCPhoneToId',
    'SAFT24kHz16BitStereo', 'ISpeechPhraseReplacement',
    'SPAUDIOBUFFERINFO', 'DISPID_SOTCId', 'SPPS_Interjection',
    'DISPID_SRGState', 'SpMemoryStream', 'SAFTADPCM_22kHzMono',
    'DISPID_SGRSTText', 'SAFT8kHz16BitStereo', 'DISPID_SPPName',
    'DISPID_SLWs_NewEnum', 'SpMMAudioOut',
    'DISPID_SAFSetWaveFormatEx', 'SpeechVisemeFeature',
    'ISpPhoneConverter', 'ISpeechWaveFormatEx',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechXMLRecoResult',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SVAudioOutputStream',
    'ISpeechObjectTokens', 'DISPID_SRSSupportedLanguages',
    'SGDSActiveUserDelimited', 'ISpEventSink', 'SPPS_RESERVED4',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRGRecoContext',
    'DISPID_SVEStreamStart', 'SpeechGrammarRuleStateTransitionType',
    'SPTEXTSELECTIONINFO', 'DISPID_SPEDisplayText', 'DISPID_SLWsItem',
    'SPWORD', 'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_MAX_TTS',
    'DISPID_SVSVisemeId', 'SPPS_Noncontent', 'SPAS_STOP', 'SVP_15',
    'DISPID_SPCLangId', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SGRSTsItem', 'SPSLMA', 'DISPID_SpeechObjectToken',
    'SDTReplacement', 'DISPID_SpeechMemoryStream', 'SVP_13',
    'SpeechGrammarTagUnlimitedDictation', 'Speech_Max_Pron_Length',
    'SPEI_PHRASE_START', 'SVP_0', 'DISPID_SVVoice',
    'ISpGrammarBuilder', 'SRSActiveAlways', 'DISPID_SRGRules',
    'SPAR_Low', 'SpeechGrammarState',
    'DISPID_SRSCurrentStreamPosition', 'SWTDeleted',
    'DISPID_SDKEnumKeys', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SLWPronunciations', 'eLEXTYPE_PRIVATE2',
    'eLEXTYPE_PRIVATE19', 'SRERecognition',
    'DISPID_SGRSTPropertyName', 'DISPID_SWFESamplesPerSec',
    'SpeechEngineProperties', 'SAFTADPCM_44kHzStereo',
    'SpeechRegistryUserRoot', 'SVP_1', 'DISPID_SWFEFormatTag',
    'DISPID_SRCVoicePurgeEvent', 'SAFTGSM610_8kHzMono',
    'SpCustomStream', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SGRSTType', 'DISPID_SPAPhraseInfo',
    'DISPID_SpeechPhraseInfo', 'SPEI_MAX_SR',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_RESERVED2', 'SpeechAudioFormatGUIDWave', 'ISpRecoResult',
    'SPAR_High', 'SDTAll', 'DISPID_SRCCmdMaxAlternates', 'SPFILEMODE',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRRRecoContext',
    'SPGRAMMARSTATE', 'SPVPRIORITY', 'eLEXTYPE_PRIVATE1',
    'SP_VISEME_11', 'DISPID_SPPParent', 'STSF_CommonAppData',
    'DISPID_SPRsCount', 'DISPID_SPAsItem', 'DISPID_SVWaitUntilDone',
    'SpeechRecoContextState', 'SpeechCategoryRecoProfiles',
    'DISPID_SRRAlternates', 'SPXRO_SML', 'SDA_Two_Trailing_Spaces',
    'SAFT22kHz16BitMono', 'SpeechRecoProfileProperties',
    'DISPID_SpeechAudioBufferInfo', 'ISpeechLexiconPronunciations',
    'SpeechAudioVolume', 'SAFT11kHz8BitStereo',
    'SpStreamFormatConverter', 'SPEI_RESERVED3', 'DISPID_SPRText',
    'SpeechWordType', 'SAFT32kHz16BitMono',
    'DISPID_SRCEPropertyStringChange', 'SAFT12kHz8BitMono',
    'DISPID_SPPsCount', 'SAFT44kHz8BitStereo',
    'DISPID_SRCEFalseRecognition', 'SPINTERFERENCE_TOOFAST',
    'SpeechCategoryAudioOut', 'SRADefaultToActive', 'DISPID_SGRId',
    'SVP_14', 'SVSFParseMask', 'SAFTADPCM_8kHzStereo',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPERetainedStreamOffset',
    'SAFTCCITT_ALaw_22kHzMono', 'SGRSTTRule', 'ISpNotifySink',
    'DISPID_SRGCmdLoadFromObject',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPSVerb',
    'SPFM_NUM_MODES', 'ISpeechObjectTokenCategory', 'SPAUDIOOPTIONS',
    'DISPID_SpeechPhraseBuilder', 'ISpPhraseAlt', 'ISpAudio',
    'eLEXTYPE_PRIVATE8', 'SpShortcut', 'DISPID_SPARecoResult',
    'SPEI_TTS_BOOKMARK', 'DISPID_SVStatus', 'STCInprocServer',
    'DISPID_SRCResume', 'DISPID_SRGetRecognizers',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRCEEnginePrivate', 'SREPrivate',
    'SAFT24kHz16BitMono', 'eLEXTYPE_APP', 'DISPID_SPRuleConfidence',
    'SVSFParseSapi', 'DISPID_SpeechPhoneConverter',
    'DISPID_SOTsCount', 'DISPID_SWFEExtraData',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPEI_FALSE_RECOGNITION',
    'SPEI_SR_AUDIO_LEVEL', 'SpLexicon', 'DISPID_SPPChildren',
    'DISPID_SVAudioOutput', 'DISPID_SGRSTRule', 'ISpeechLexiconWord',
    'DISPID_SRAudioInput', 'SREPhraseStart', 'SPAO_NONE',
    'SDKLLocalMachine', 'SITooQuiet',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPPEngineConfidence', 'SPSHORTCUTPAIR',
    'DISPID_SABIBufferSize', 'DISPID_SOTCSetId', 'SpMMAudioEnum',
    'SAFT32kHz8BitMono', 'DISPID_SPIProperties', 'SPEI_UNDEFINED',
    'DISPID_SPPFirstElement', 'DISPID_SRGSetTextSelection',
    'SAFTADPCM_11kHzMono', 'SPCT_DICTATION', 'SRAExport',
    'ISpObjectToken', 'SPDKL_LocalMachine', 'ISpProperties',
    'SpStream', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SpeechBaseStream', 'eLEXTYPE_RESERVED9',
    'SpeechRecognitionType', 'DISPID_SPPNumberOfElements',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SAFType', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SDKSetStringValue',
    'SDTDisplayText', 'ISpeechRecoResultDispatch',
    'SSSPTRelativeToCurrentPosition', 'ISpDataKey',
    'DISPID_SLAddPronunciation', 'DISPID_SpeechRecoResult2',
    'ISpeechRecognizerStatus', 'SPFM_CREATE',
    'DISPID_SVSInputWordLength', 'DISPID_SRCESoundStart',
    'ISpRecognizer2', 'DISPID_SPRsItem', 'SP_VISEME_7',
    'SVSFParseAutodetect', 'SP_VISEME_1', 'SpeechTokenShellFolder',
    'SpeechAddRemoveWord', 'SpMMAudioIn', 'ISpeechPhraseAlternates',
    'SPSUnknown', 'ISpSerializeState', 'DISPID_SVEStreamEnd',
    'SP_VISEME_6', 'eLEXTYPE_PRIVATE14', 'SPBO_AHEAD', 'SP_VISEME_3',
    'SPSHT_Unknown', 'SVSFlagsAsync', 'ISpeechVoiceStatus',
    'SpeechDisplayAttributes', 'DISPID_SRIsShared',
    'SpeechRetainedAudioOptions', 'SAFTText',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SGRSTs_NewEnum',
    'SRTExtendableParse', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPEEngineConfidence', 'SRSActive', 'SPFM_OPEN_READWRITE',
    'SAFT12kHz16BitMono', 'SPXMLRESULTOPTIONS',
    'DISPID_SpeechPhraseRules', 'DISPID_SPIRetainedSizeBytes',
    'SWPKnownWordPronounceable', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechCustomStream',
    'DISPID_SRRAudio', 'ISpeechXMLRecoResult', 'SpInprocRecognizer',
    'ISpPhrase', 'SREPropertyStringChange', '__MIDL_IWinTypes_0009',
    'ISpeechVoice', 'DISPID_SCSBaseStream', 'DISPID_SPCIdToPhone',
    'DISPID_SRCRequestedUIType', 'DISPID_SVEWord', 'SREAudioLevel',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechAudioStatus',
    'eLEXTYPE_PRIVATE13', 'DISPID_SVPriority', 'SpeechRuleState',
    'SpNotifyTranslator', 'eLEXTYPE_PRIVATE11', 'SRADynamic',
    'SPSMF_UPS', 'SPPROPERTYINFO', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRGDictationSetState', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SpeechRecoContextEvents', 'SPRST_NUM_STATES',
    'DISPID_SVDisplayUI', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRRSetTextFeedback', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SPAsCount', 'DISPID_SWFEChannels', 'SPXRO_Alternates_SML',
    'DISPID_SVSInputWordPosition', 'SAFTNoAssignedFormat',
    'SAFT16kHz8BitMono', 'SAFT24kHz8BitStereo', 'DISPID_SGRSRule',
    'DISPID_SPIReplacements', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SFTSREngine', 'DISPID_SVSyncronousSpeakTimeout',
    'SPINTERFERENCE', 'DISPID_SGRSAddSpecialTransition',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRGDictationLoad',
    'DISPID_SRRTLength', 'DISPID_SLAddPronunciationByPhoneIds',
    'SITooSlow', 'DISPID_SDKDeleteValue', 'SPEI_REQUEST_UI',
    'SRTEmulated', 'DISPID_SVSpeak', 'SAFT44kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SLGenerationId', 'SPVPRI_NORMAL', 'eWORDTYPE_DELETED',
    'SPDKL_CurrentUser', 'SpTextSelectionInformation',
    'DISPID_SVESentenceBoundary', 'SpFileStream',
    'ISpeechAudioBufferInfo', 'DISPID_SOTDisplayUI',
    'DISPID_SRCreateRecoContext', 'ISpeechDataKey',
    'SECFEmulateResult', 'SAFT11kHz16BitMono', 'eWORDTYPE_ADDED',
    'ISpRecoGrammar', 'SRSEDone', 'STCInprocHandler', 'SGRSTTWord',
    'SRAONone', 'SAFTGSM610_44kHzMono', 'DISPID_SPEActualConfidence',
    'SPPS_RESERVED2', 'SPEI_SR_BOOKMARK', 'eLEXTYPE_RESERVED6',
    'SVSFUnusedFlags', 'SPSSuppressWord', 'DISPID_SRIsUISupported',
    'DISPID_SPEAudioSizeTime', 'ISpLexicon', 'DISPID_SMSAMMHandle',
    'SPAR_Medium', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPRs_NewEnum', 'DISPID_SDKOpenKey',
    'IInternetSecurityManager', 'SpeechTokenKeyUI',
    'SPEI_PROPERTY_NUM_CHANGE', 'SDTPronunciation', 'LONG_PTR',
    'DISPID_SRAudioInputStream', 'SINoise', 'SVSFNLPMask',
    'SPEI_RECO_STATE_CHANGE', 'Speech_Max_Word_Length', 'SVEPhoneme',
    'SpeechVisemeType', 'DISPID_SLPPhoneIds', 'ISpeechObjectToken',
    'DISPID_SLPLangId', 'DISPID_SLPs_NewEnum', 'SECHighConfidence',
    'SpeechStreamSeekPositionType', 'ISpeechPhraseElement',
    'SPEI_VOICE_CHANGE', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechFormatType', 'SSSPTRelativeToStart', 'SRESoundEnd',
    'SECLowConfidence', 'SVP_12', 'DISPID_SpeechAudio', 'SPPS_Noun',
    'SPDKL_CurrentConfig', 'DISPID_SVEEnginePrivate', 'SP_VISEME_14',
    'ISpRecognizer', 'SAFT48kHz8BitStereo', 'ISpRecognizer3',
    'SECFNoSpecialChars', 'DISPID_SpeechAudioFormat',
    'SPEI_END_SR_STREAM', 'ISpNotifySource', 'SPCATEGORYTYPE',
    'DISPID_SPIStartTime', 'SP_VISEME_5', 'SPWT_LEXICAL', 'SVF_None',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRGetPropertyString',
    'DISPID_SMSGetData', 'SDKLCurrentUser', 'SPPS_Unknown'
]

_check_version('1.1.14', 1610478947.171059)
